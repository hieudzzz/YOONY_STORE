...
const ListVarriant = () => {
    return (
        <div className="relative overflow-x-auto">
            <Link to={"/admin/products/varriant/add"}>
                <button className="w-36 rounded-md mt-3 mb-3 h-10 bg-primary text-xs text-secondary-500 uppercase tracking-wider">
                    THÊM BIẾN THỂ
                </button>
            </Link>
            <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400 shadow-md rounded-lg overflow-hidden">
                    ...
                    <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-red-600">
                            <div className="flex  space-x-4">
                                <Link to={"/admin/products/varriant/addValue"}>
                                    <svg
